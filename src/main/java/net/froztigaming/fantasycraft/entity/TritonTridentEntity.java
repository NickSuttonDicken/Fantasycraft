...
public class TritonTridentEntity extends PersistentProjectileEntity {
    ...
    public TritonTridentEntity(EntityType<? extends TritonTridentEntity> entityType, World world) {
        super(entityType, world);
        this.tridentStack = new ItemStack(ItemInit.TRITON_TRIDENT);
    }
    ...
    static {
        ...
        ENCHANTED = DataTracker.registerData(TritonTridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }

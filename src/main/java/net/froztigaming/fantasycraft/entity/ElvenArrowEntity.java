...
public class ElvenArrowEntity extends PersistentProjectileEntity {
    ...
    public ElvenArrowEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
    ...
    static {
        COLOR = DataTracker.registerData(ElvenArrowEntity.class, TrackedDataHandlerRegistry.INTEGER);
    }

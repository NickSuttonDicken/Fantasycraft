...
public class GenericFantasycraftChestBlock extends BlockWithEntity implements Waterloggable {
    ...
    protected final ChestTypes type;

    private final Supplier<BlockEntityType<? extends GenericFantasycraftChestEntity>> entityTypeRetriever;
    ...
    public GenericFantasycraftChestBlock(FabricBlockSettings settings, ChestTypes type, Supplier<BlockEntityType<? extends GenericFantasycraftChestEntity>> entityTypeRetriever) {
        super(settings);
    ...
    public DoubleBlockProperties.PropertySource<? extends GenericFantasycraftChestEntity> getBlockEntitySource(BlockState state, World world, BlockPos pos, boolean ignoreBlocked) {
        ...
        return DoubleBlockProperties.toPropertySource((BlockEntityType)this.entityTypeRetriever.get(), GenericFantasycraftChestBlock::getMergerType, GenericFantasycraftChestBlock::getDirectionToAttached, FACING, state, world, pos, biPredicate);
    }
    ...
    public static DoubleBlockProperties.PropertyRetriever<GenericFantasycraftChestEntity, Float2FloatFunction> getAnimationProgressRetriever(final ChestAnimationProgress chestAnimationProgress) {
        return new DoubleBlockProperties.PropertyRetriever<GenericFantasycraftChestEntity, Float2FloatFunction>() {
            public Float2FloatFunction getFromBoth(GenericFantasycraftChestEntity chestBlockEntity, GenericFantasycraftChestEntity chestBlockEntity2) {
                return (f) -> Math.max(chestBlockEntity.getAnimationProgress(f), chestBlockEntity2.getAnimationProgress(f));
            }

            public Float2FloatFunction getFrom(GenericFantasycraftChestEntity chestBlockEntity) {

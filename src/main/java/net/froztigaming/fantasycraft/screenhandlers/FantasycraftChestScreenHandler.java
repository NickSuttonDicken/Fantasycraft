package net.froztigaming.fantasycraft.screenhandlers;
...
public class FantasycraftChestScreenHandler extends SyncedGuiDescription {

    Inventory inventory;

    public FantasycraftChestScreenHandler(ScreenHandlerType<?> type, ChestTypes chestType, int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {

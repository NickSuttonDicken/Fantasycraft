        ...
        if (user instanceof PlayerEntity) {
            ...
            if (i >= 10) {
                if (!world.isClient) {
                    ...
                    TritonTridentEntity tritonTridentEntity = new TritonTridentEntity(world, playerEntity, this, stack);
                    tritonTridentEntity.setProperties(playerEntity, playerEntity.pitch, playerEntity.yaw, 0.0F, 2.5F, 1.0F);
                    if (playerEntity.abilities.creativeMode) {
                        tritonTridentEntity.pickupType = PersistentProjectileEntity.PickupPermission.CREATIVE_ONLY;
                    }
                    world.spawnEntity(tritonTridentEntity);
                    world.playSoundFromEntity(null, tritonTridentEntity, SoundEvents.ITEM_TRIDENT_THROW, SoundCategory.PLAYERS, 1.0F,
                            1.0F);
                    if (!playerEntity.abilities.creativeMode) {

package net.fabricmc.fantasycraft.register;
...
import net.fabricmc.fantasycraft.blocks.containers.DwarvenBlastFurnace;
import net.fabricmc.fantasycraft.blocks.materialblocks.MithrilBlock;
import net.fabricmc.fantasycraft.blocks.ores.MithrilOre;
import net.fabricmc.fantasycraft.client.DwarvenBlastFurnaceScreen;
...
import net.fabricmc.fantasycraft.items.ingots.MithrilIngot;
import net.fabricmc.fantasycraft.recipe.DwarvenBlasting;
import net.fabricmc.fantasycraft.tools.mithril.*;
...
public class Registration {
    ...
    //Items
    public static final MithrilIngot MITHRIL_INGOT = new MithrilIngot(new Item.Settings().group(Registration.Fantasycraft));
    ...
    //Tools
    public static ToolItem MITHRIL_SHOVEL = new MithrilShovel(MithrilMaterial.INSTANCE, 6.5f, -3.0f, new Item.Settings().group(Registration.Fantasycraft));
    public static ToolItem MITHRIL_PICKAXE = new MithrilPickaxe(MithrilMaterial.INSTANCE, 7, -2.8f, new Item.Settings().group(Registration.Fantasycraft));
    public static ToolItem MITHRIL_AXE = new MithrilAxe(MithrilMaterial.INSTANCE, 10, -3.0f, new Item.Settings().group(Registration.Fantasycraft));
    public static ToolItem MITHRIL_HOE = new MithrilHoe(MithrilMaterial.INSTANCE, 1, 0f, new Item.Settings().group(Registration.Fantasycraft));
    public static ToolItem MITHRIL_SWORD = new MithrilSword(MithrilMaterial.INSTANCE, 8, -2.4f, new Item.Settings().group(Registration.Fantasycraft));

    //Armor
    public static final ArmorMaterial MITHRIL_ARMOR_MATERIAL = new MithrilArmorMaterial();
    public static final Item MITHRIL_HELMET = new ArmorItem(MITHRIL_ARMOR_MATERIAL, EquipmentSlot.HEAD, new Item.Settings().group(Registration.Fantasycraft));
    public static final Item MITHRIL_CHESTPLATE = new ArmorItem(MITHRIL_ARMOR_MATERIAL, EquipmentSlot.CHEST, new Item.Settings().group(Registration.Fantasycraft));
    public static final Item MITHRIL_LEGGINGS = new ArmorItem(MITHRIL_ARMOR_MATERIAL, EquipmentSlot.LEGS, new Item.Settings().group(Registration.Fantasycraft));
    public static final Item MITHRIL_BOOTS = new ArmorItem(MITHRIL_ARMOR_MATERIAL, EquipmentSlot.FEET, new Item.Settings().group(Registration.Fantasycraft));
    ...
    //Client
    public static ScreenHandlerType<DwarvenBlastFurnaceScreenHandler> DWARVEN_BLAST_FURNACE_SCREEN_HANDLER;
    ...
    {
        ScreenRegistry.register(Registration.DWARVEN_BLAST_FURNACE_SCREEN_HANDLER, DwarvenBlastFurnaceScreen::new);
    }
    ...
    public static final ItemGroup Fantasycraft = FabricItemGroupBuilder.create(
            ...
            .icon(() -> new ItemStack(MITHRIL_SWORD))
            .build();
}
